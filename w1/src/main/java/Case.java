...
//public class Case {
//
//    private final one.HelperClass helper = new one.HelperClass();
//    private final one.ShoppingCart shoppingCart = new one.ShoppingCart();
...
//
//
//                    shoppingCart.addItem(itemName, new one.Item(price, quantity));
//                    break;
//
//                case 2:
//                    scan.nextLine();
